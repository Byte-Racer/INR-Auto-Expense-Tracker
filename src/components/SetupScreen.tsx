...
export default function SetupScreen({ onComplete }: SetupScreenProps) {
  const [initialCashBalance, setInitialCashBalance] = useState<string>("");
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-950 text-white p-6">
      <div className="w-full max-w-md space-y-8">
        ...
        <form
          ...
          className="space-y-6 bg-zinc-900 p-6 rounded-2xl border border-zinc-800 shadow-xl"
        >
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              placeholder={
                warningType === "percentage" ? "e.g. 20 (for 20%)" : "e.g. 5000"
              }
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 text-white placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all"
              required
            />
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-zinc-500">
              If your balance drops below this, you'll need to justify every
              expense.
            </p>
          </div>
